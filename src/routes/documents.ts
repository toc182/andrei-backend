...
const documentLimiter = rateLimit({
  ...
  message: {
    success: false,
    message:
      'Demasiadas solicitudes de documentos. Por favor espera 15 minutos.',
  },
...
router.post(
  '/acuerdo-consorcio-preview',
  authenticateToken,
  async (
    req: Request<object, object, DocumentBody>,
    res: Response,
  ): Promise<void> => {
    try {
      ...
      const htmlPath = path.resolve(
        __dirname,
        '../../templates/acuerdoConsorcioTemplate.html',
      );
      ...
      res.status(500).json({
        success: false,
        message: 'Error interno al generar vista previa',
      });
    }
  },
);
  ...
  async (
    ...
    try {
      ...
      const pdfPath = path.resolve(
        __dirname,
        '../../templates/acuerdo-consorcio.pdf',
      );
      await page.pdf({
        path: pdfPath,
        format: 'legal',
      ...
      res.status(500).json({
        success: false,
        message: 'Error interno al generar documento',
      });
    }
  },
);
...
router.post(
  ...
  async (
    ...
    try {
      ...
      const htmlPath = path.resolve(
        __dirname,
        '../../templates/adhesionPinellasTemplate.html',
      );
      let htmlContent = fs.readFileSync(htmlPath, 'utf8');
...
router.post(
  ...
  async (
    ...
    try {
      ...
      const pdfPath = path.resolve(
        __dirname,
        '../../templates/adhesion-pinellas.pdf',
      );
      await page.pdf({
        path: pdfPath,
        format: 'legal',
...
router.post(
  ...
  async (
    ...
    try {
      ...
      const htmlPath = path.resolve(
        __dirname,
        '../../templates/adhesionConsorcioTemplate.html',
      );
      let htmlContent = fs.readFileSync(htmlPath, 'utf8');
...
router.post(
  ...
  async (
    ...
    try {
      ...
      const pdfPath = path.resolve(
        __dirname,
        '../../templates/adhesion-consorcio.pdf',
      );
      await page.pdf({
        path: pdfPath,
        format: 'legal',
...
router.post(
  ...
  async (
    ...
    try {
      ...
      const htmlPath = path.resolve(
        __dirname,
        '../../templates/retorsionPinellasTemplate.html',
      );
      let htmlContent = fs.readFileSync(htmlPath, 'utf8');
...
router.post(
  ...
  async (
    ...
    try {
      ...
      const pdfPath = path.resolve(
        __dirname,
        '../../templates/retorsion-pinellas.pdf',
      );
      await page.pdf({
        path: pdfPath,
        format: 'legal',
...
router.post(
  ...
  async (
    ...
    try {
      ...
      const htmlPath = path.resolve(
        __dirname,
        '../../templates/retorsionConsorcioTemplate.html',
      );
      let htmlContent = fs.readFileSync(htmlPath, 'utf8');
...
router.post(
  ...
  async (
    ...
    try {
      ...
      const pdfPath = path.resolve(
        __dirname,
        '../../templates/retorsion-consorcio.pdf',
      );
      await page.pdf({
        path: pdfPath,
        format: 'legal',
...
router.post(
  ...
  async (
    ...
    try {
      ...
      const htmlPath = path.resolve(
        __dirname,
        '../../templates/incapacidadPinellasTemplate.html',
      );
      let htmlContent = fs.readFileSync(htmlPath, 'utf8');
...
router.post(
  ...
  async (
    ...
    try {
      ...
      const pdfPath = path.resolve(
        __dirname,
        '../../templates/incapacidad-pinellas.pdf',
      );
      await page.pdf({
        path: pdfPath,
        format: 'legal',
...
router.post(
  ...
  async (
    ...
    try {
      ...
      const htmlPath = path.resolve(
        __dirname,
        '../../templates/incapacidadConsorcioTemplate.html',
      );
      let htmlContent = fs.readFileSync(htmlPath, 'utf8');
...
router.post(
  ...
  async (
    ...
    try {
      ...
      const pdfPath = path.resolve(
        __dirname,
        '../../templates/incapacidad-consorcio.pdf',
      );
      await page.pdf({
        path: pdfPath,
        format: 'legal',
...
router.post(
  ...
  async (
    ...
    try {
      ...
      const htmlPath = path.resolve(
        __dirname,
        '../../templates/integridadPinellasTemplate.html',
      );
      let htmlContent = fs.readFileSync(htmlPath, 'utf8');
...
router.post(
  ...
  async (
    ...
    try {
      ...
      const pdfPath = path.resolve(
        __dirname,
        '../../templates/integridad-pinellas.pdf',
      );
      await page.pdf({
        path: pdfPath,
        format: 'legal',
...
router.post(
  ...
  async (
    ...
    try {
      ...
      const htmlPath = path.resolve(
        __dirname,
        '../../templates/integridadConsorcioTemplate.html',
      );
      let htmlContent = fs.readFileSync(htmlPath, 'utf8');
...
router.post(
  ...
  async (
    ...
    try {
      ...
      const pdfPath = path.resolve(
        __dirname,
        '../../templates/integridad-consorcio.pdf',
      );
      await page.pdf({
        path: pdfPath,
        format: 'legal',
